...
namespace Profit
{
    public partial class SearchPurchaseReturnForm : KryptonForm
    {
        PurchaseReturnRepository r_grn = (PurchaseReturnRepository)RepositoryFactory.GetInstance().GetTransactionRepository(RepositoryFactory.PURCHASE_RETURN_REPOSITORY);
        ...
        public SearchPurchaseReturnForm(string textfind, IList result)//Point p)
        {
            InitializeComponent();
