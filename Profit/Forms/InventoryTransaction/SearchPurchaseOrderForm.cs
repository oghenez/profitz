...
namespace Profit
{
    public partial class SearchPurchaseOrderForm : KryptonForm
    {
        ...
        Repository r_supplier = RepositoryFactory.GetInstance().GetRepository(RepositoryFactory.SUPPLIER_REPOSITORY);
        ...
        private void loadResult(IList records)
        {
            foreach (PurchaseOrder d in records)
            {
                ...
                d.SUPPLIER = (Supplier)r_supplier.GetById(d.SUPPLIER);
