...
namespace Profit
{
    public partial class CustomerOutstandingInvoiceForm : KryptonForm, IChildForm
    {
        CustomerOutStandingInvoice m_prn = new CustomerOutStandingInvoice(); 
        ...
        public CustomerOutstandingInvoiceForm(IMainForm mainForm, string formName)
        {
            InitializeComponent();
        ...
        void dataItemskryptonDataGridView_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            //    CustomerOutStandingInvoiceItem sample = new CustomerOutStandingInvoiceItem();
            //    sample.PART = p;
            //    sample.UNIT = u;
        ...
        private void InitializeDataSource()
        {
            ...
            m_tops = r_top.GetAll();
            m_employee = r_employee.GetAllSalesman();
        ...
        private IList getItems()
        {
            ...
            for (int i = 0; i < itemsDataGrid.Rows.Count; i++)
            {
                ...
                if (st == null) st = new CustomerOutStandingInvoiceItem();
        ...
        private void loadData()
        {
            ...
            itemsDataGrid.Rows.Clear();
            foreach (CustomerOutStandingInvoiceItem item in m_prn.EVENT_JOURNAL_ITEMS)
            {
