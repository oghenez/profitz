...
namespace Profit
{
    public partial class SalesReturnForm : KryptonForm, IChildForm
    {
        SalesReturn m_prn = new SalesReturn(); 
        ...
        public SalesReturnForm(IMainForm mainForm, string formName)
        {
            InitializeComponent();
        ...
        void dataItemskryptonDataGridView_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            if (QtyColumn.Index == e.ColumnIndex)
            {
                ...
                SalesReturnItem sample = new SalesReturnItem();
                sample.PART = p;
                sample.UNIT = u;
        ...
        private IList getItems()
        {
            ...
            for (int i = 0; i < itemsDataGrid.Rows.Count; i++)
            {
                ...
                SalesReturnItem st=(SalesReturnItem)itemsDataGrid.Rows[i].Tag;
                if(st==null) st = new SalesReturnItem();
