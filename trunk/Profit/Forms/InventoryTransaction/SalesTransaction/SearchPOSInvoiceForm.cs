...
namespace Profit
{
    public partial class SearchPOSForm : KryptonForm
    {
        POSRepository r_po = (POSRepository)RepositoryFactory.GetInstance().GetTransactionRepository(RepositoryFactory.POS_REPOSITORY);
        ...
        public SearchPOSForm(string textfind, IList result)//Point p)
        {
            InitializeComponent();
