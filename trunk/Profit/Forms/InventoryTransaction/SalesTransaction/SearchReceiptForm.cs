...
namespace Profit
{
    public partial class SearchReceiptForm : KryptonForm
    {
        ...
        public SearchReceiptForm(string textfind, IList result, User p)
        {
            InitializeComponent();
        ...
        private void gridData_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                RECEIPT = (Receipt)gridData.SelectedRows[0].Tag;
                this.Close();
            }
        }
