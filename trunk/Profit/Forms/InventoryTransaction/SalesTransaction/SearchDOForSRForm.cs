...
namespace Profit
{
    public partial class SearchDOForSRForm : KryptonForm
    {
        ...
        public SearchDOForSRForm(string textfind, Customer supplier, IList added, User user, DateTime trDate)
        {
            InitializeComponent();
            m_user = user;
            m_trDate = trDate;
        ...
        private void buttonSpecAny1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                IList records = r_po.FindSObyPartAndDONo(searchText.Text.Trim(), m_listAdded, m_supplierID.ID, m_trDate);
                loadResult(records);
