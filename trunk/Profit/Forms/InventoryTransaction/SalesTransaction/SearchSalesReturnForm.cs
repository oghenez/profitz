...
namespace Profit
{
    public partial class SearchSalesReturnForm : KryptonForm
    {
        SalesReturnRepository r_grn = (SalesReturnRepository)RepositoryFactory.GetInstance().GetTransactionRepository(RepositoryFactory.SALES_RETURN_REPOSITORY);
        ...
        public SearchSalesReturnForm(string textfind, IList result)//Point p)
        {
            InitializeComponent();
        ...
        private void SearchSalesReturnForm_Load(object sender, EventArgs e)
        {
            UserSetting.LoadSetting(gridData, 1, this.Name);
        }

        private void SearchSalesReturnForm_FormClosing(object sender, FormClosingEventArgs e)
        {
